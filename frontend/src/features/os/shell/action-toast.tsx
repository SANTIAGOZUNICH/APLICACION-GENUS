...
export function ActionToast() {
  ...
  return (
    <div
      role="status"
      className="os-slide-up pointer-events-auto fixed bottom-8 left-1/2 z-[var(--os-z-toast)] flex -translate-x-1/2 items-center gap-3 rounded-full border border-[var(--os-border)] bg-[var(--os-surface-glass)] px-5 py-3 shadow-[var(--os-shadow-card-hover)] backdrop-blur-md"
    >
      <CheckCircle2 className="size-5 text-[var(--genus-success)]" aria-hidden="true" />
